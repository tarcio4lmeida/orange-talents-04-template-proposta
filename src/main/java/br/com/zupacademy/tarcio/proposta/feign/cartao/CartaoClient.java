...
import br.com.zupacademy.tarcio.proposta.cadastro_associacao_paypal.CarteiraDigitalRequest;
...
public interface CartaoClient {
    ...
    public NotificaCarteiraDigitalResponse getCarteiras(@PathVariable("id") String id, @RequestBody @Valid CarteiraDigitalRequest request);
}
